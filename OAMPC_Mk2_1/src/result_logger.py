...
class ResultLogger:
    ...
    def __init__(self, config: dict[str, Any]):
        ...
        self.run_prefix = "run_ObsAv_Mk2_1_"
    ...
    def _save_csv_files(self) -> None:
        ...
        write_dict_csv(self.run_folder / "solve_times.csv", self.rows, ["t", "solve_time", "solver_success", "solver_status", "number_of_config_obstacles", "number_of_active_obstacles", "number_of_active_edges"])
