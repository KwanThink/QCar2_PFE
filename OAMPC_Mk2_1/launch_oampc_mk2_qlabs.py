...
from src.obstacle_activation import prepare_obstacle_activation, select_active_obstacles
...
# Run progress-based reference tracking with path-progress obstacle activation.
def run_control_loop(
    ...
    try:
        while True:
            ...
            activation_config = config["obstacle_avoidance"].get("activation", {})
            active_obstacles = select_active_obstacles(
...
def main() -> None:
    ...
    try:
        ...
        obstacle_list = prepare_obstacle_activation(obstacle_list, reference_manager)
