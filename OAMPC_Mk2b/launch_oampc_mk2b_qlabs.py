#!/usr/bin/env python3
"""Launch QCar2 Mk2b OAMPC obstacle-avoidance tracking in Quanser Interactive Labs."""
...
from src.obstacle_activation import ObstacleActivationManager
...
# Run reference tracking with local geometric obstacle activation.
def run_control_loop(
    ...
    try:
        while True:
            ...
            active_obstacles = obstacle_activation_manager.update(
            ...
            solver_result = solver.solve(
                ...
                obstacle_list=active_obstacles,
            )
            ...
            logger.record(
                ...
                active_obstacles=solver_result.active_obstacles,
                active_edges=solver_result.active_edges,
                binary_variables=solver_result.binary_variables,
                total_binary_variables=solver_result.total_binary_variables,
