#!/usr/bin/env python3
"""Launch QCar2 NLMPC Mk2Gu obstacle-avoidance tracking in QLabs."""
...
def run_control_loop(
    ...
    from src.single_track_gurobi_nlmpc import GurobiSingleTrackNLMPC, angle_error, unwrap_to_reference
    ...
    solver = GurobiSingleTrackNLMPC(config, obstacle_file_config)
    logger.start()
    ...
    try:
        while True:
            ...
            if mode == "GO_TO_START":
                ...
                reference_state_horizon, reference_input_horizon = reference_manager.build_fixed_target_horizon(
                    start_target_state,
                    horizon_steps,
                )
                ...
                reference_state_horizon, reference_input_horizon = reference_manager.build_horizon(
                    ref_index,
                    horizon_steps,
            ...
            logger.record(
                ...
                number_of_obstacle_edges=solver_result.number_of_obstacle_edges,
...
def main() -> None:
    ...
    try:
        import src.single_track_gurobi_nlmpc  # noqa: F401
