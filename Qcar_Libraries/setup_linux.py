...
def main():
        ...
        copyLibrariesToROSDocker =  subprocess.call("cp -r /home/$USER/Documents/ACC_Development/src/libraries/ /home/$USER/Documents/ACC_Development/docker/",shell=True)

        # copy python dev to ros docker to enable non-ros development 
        copyPythonDevToROSDocker =  subprocess.call("cp -r /home/$USER/Documents/ACC_Development/src/examples/sdcs/qcar2/python_dev /home/$USER/Documents/ACC_Development/Development",shell=True)
