...
RT_MODEL_QCar2_hardware_test__T *QCar2_hardware_test_intel_realsense(void)
{
  ...
  /* External mode info */
  QCar2_hardware_test_intel_re_M->Sizes.checksums[0] = (1279489484U);
  QCar2_hardware_test_intel_re_M->Sizes.checksums[1] = (4193232206U);
  QCar2_hardware_test_intel_re_M->Sizes.checksums[2] = (1715601137U);
  QCar2_hardware_test_intel_re_M->Sizes.checksums[3] = (1562832192U);
