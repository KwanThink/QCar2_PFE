...
typedef RT_MODEL_QCar2_hardware_test__T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * QCar2_hardware_test_intel_realsense(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(QCar2_hardware_test_intel_re_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: QCar2_hardware_test_intel_realsense -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  S = QCar2_hardware_test_intel_realsense();
  if (rtmGetErrorStatus(S) != NULL) {
