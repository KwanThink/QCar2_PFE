...
#include "QCar2_autonomous_driving_example1_dt.h"

/* Named constants for MATLAB Function: '<S4>/Draw Lines Module1' */
...
void QCar2_autonomous_driving_example1_output0(void) /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (tmp) {
    ...
    rtb_Memory = (QCar2_autonomous_driving_exa_DW.clockTickCounter <
    ...
    QCar2_autonomous_driving_exam_B.AND3 =
      ((QCar2_autonomous_driving_exam_B.RateTransition >
        QCar2_autonomous_driving_exam_P.LeftSteeringLimit_const) && (rtb_Memory
        != 0.0));
    ...
    QCar2_autonomous_driving_exam_B.AND1 =
      ((QCar2_autonomous_driving_exam_B.RateTransition <
        QCar2_autonomous_driving_exam_P.RightSteeringLimit_const) && (rtb_Memory
        != 0.0));
    ...
    if (QCar2_autonomous_driving_exam_B.uArm0Disarm1 >
      ...
      if (QCar2_autonomous_driving_exam_P.SpeedMaxms_Value >
        ...
        rtb_Memory = QCar2_autonomous_driving_exam_P.Saturation1_UpperSat;
      } else if (QCar2_autonomous_driving_exam_P.SpeedMaxms_Value <
                 QCar2_autonomous_driving_exam_P.Saturation1_LowerSat) {
        rtb_Memory = QCar2_autonomous_driving_exam_P.Saturation1_LowerSat;
      } else {
        rtb_Memory = QCar2_autonomous_driving_exam_P.SpeedMaxms_Value;
      }

      /* End of Saturate: '<Root>/Saturation1' */
    } else {
      rtb_Memory = QCar2_autonomous_driving_exam_P.Constant9_Value;
    }

    /* End of Switch: '<Root>/Switch' */

    /* RateLimiter: '<Root>/Rate Limiter' */
    rateLimiterRate = rtb_Memory - QCar2_autonomous_driving_exa_DW.PrevY;
    if (rateLimiterRate > QCar2_autonomous_driving_exam_P.RateLimiter_RisingLim *
        QCar2_autonomous_driving_period) {
      rtb_Memory = QCar2_autonomous_driving_exam_P.RateLimiter_RisingLim *
        QCar2_autonomous_driving_period + QCar2_autonomous_driving_exa_DW.PrevY;
               ...
               QCar2_autonomous_driving_period) {
      rtb_Memory = QCar2_autonomous_driving_exam_P.RateLimiter_FallingLim *
        QCar2_autonomous_driving_period + QCar2_autonomous_driving_exa_DW.PrevY;
    }

    QCar2_autonomous_driving_exa_DW.PrevY = rtb_Memory;
    ...
    QCar2_autonomous_driving_exam_B.speed_cmd = rtb_Memory;
    if (QCar2_autonomous_driving_exam_B.RateTransition1 <
      ...
      rtb_Memory /= QCar2_autonomous_driving_exam_P.Constant2_Value_f -
        QCar2_autonomous_driving_exam_P.Constant_Value_p;
      QCar2_autonomous_driving_exam_B.speed_cmd = rtb_Memory *
        QCar2_autonomous_driving_exam_B.RateTransition1 - rtb_Memory *
        QCar2_autonomous_driving_exam_P.Constant_Value_p;
    }
    ...
    if (QCar2_autonomous_driving_exam_P.Constant1_Value_f1 >
      ...
      rtb_Memory = cos(QCar2_autonomous_driving_exam_B.RateTransition);
      ...
      if ((rtb_Memory < 0.0) &&
        ...
        rateLimiterRate = -rt_powd_snf(-rtb_Memory,
          QCar2_autonomous_driving_exam_P.Constant_Value_j);
      } else {
        rateLimiterRate = rt_powd_snf(rtb_Memory,
          QCar2_autonomous_driving_exam_P.Constant_Value_j);
  ...
  /* Sum: '<S20>/Sum' */
  rtb_Memory = QCar2_autonomous_driving_exam_B.desired -
    QCar2_autonomous_driving_exam_B.measured;
  if (tmp) {
  ...
  QCar2_autonomous_driving_exam_B.pwmdutycycle =
    ((QCar2_autonomous_driving_exam_P.Kpms_Gain * rtb_Memory +
      QCar2_autonomous_driving_exam_X.Integrator1_CSTATE_b) +
     QCar2_autonomous_driving_exam_B.Kffms) *
    QCar2_autonomous_driving_exam_B.uArm0Disarm1;
  if (tmp) {
  ...
  if (QCar2_autonomous_driving_exam_B.one_shot_block >=
    ...
    rateLimiterRate = QCar2_autonomous_driving_exam_P.Constant_Value_di;
  }
...
void QCar2_autonomous_driving_example1_output2(void) /* Sample time: [0.01s, 0.0s] */
{
   ...
   */
  QCar2_autonomous_driving_exa_DW.RateTransition3_Buffer0[0] = rtb_SampleTime;
  QCar2_autonomous_driving_exa_DW.RateTransition3_Buffer0[1] =
  ...
  rtb_RateTransition2 = QCar2_autonomous_driving_exa_DW.RateTransition2_Buffer0;
                                ...
                                /* Sample time: [0.016666666666666666s, 0.0s] */
{
   ...
   */
  QCar2_autonomous_driving_exa_DW.RateTransition4_Buffer0[0] = rtb_SampleTime_l;
  QCar2_autonomous_driving_exa_DW.RateTransition4_Buffer0[1] =
   ...
   *  S-Function (video_capture_block): '<S15>/Video Capture'
   */
  QCar2_autonomous_driving_exa_DW.sfEvent_a = QCar2_autonomous_dri_CALL_EVENT;
  for (i = 0; i < 820; i++) {
    for (d = 0; d < 200; d++) {
      portWid = 410 * i + d;
      y_f_tmp = 200 * i + d;
      QCar2_autonomous_driving_exam_B.y_f[y_f_tmp] =
        QCar2_autonomous_driving_exam_B.VideoCapture_o1[portWid + 210];
      QCar2_autonomous_driving_exam_B.y_f[y_f_tmp + 164000] =
        QCar2_autonomous_driving_exam_B.VideoCapture_o1[portWid + 336410];
      QCar2_autonomous_driving_exam_B.y_f[y_f_tmp + 328000] =
  ...
  /* S-Function Block: QCar2_autonomous_driving_example1/colorThresholdingHSV/HSV Color Thresholding1 (image_compare_block) */
  {
    ...
    do {
      if ((comparison0 & COMPARE_WRAP) == 0) {
        if (QCar2_autonomous_driving_exam_B.minhue < 0) {
          minimum = 0;
        } else if (QCar2_autonomous_driving_exam_B.minhue > 255U) {
          minimum = 255U;
        } else {
          minimum = (t_uint8) QCar2_autonomous_driving_exam_B.minhue;
        }

        if (QCar2_autonomous_driving_exam_B.maxhue < 0) {
          maximum = 0;
        } else if (QCar2_autonomous_driving_exam_B.maxhue > 255U) {
          maximum = 255U;
        } else {
          maximum = (t_uint8) QCar2_autonomous_driving_exam_B.maxhue;
        }
      } else {
        minimum = (t_uint8) (QCar2_autonomous_driving_exam_B.minhue - 256U *
                             floor(QCar2_autonomous_driving_exam_B.minhue / 256U));
        maximum = (t_uint8) (QCar2_autonomous_driving_exam_B.maxhue - 256U *
                             floor(QCar2_autonomous_driving_exam_B.maxhue / 256U));
      }
      ...
      if ((comparison1 & COMPARE_WRAP) == 0) {
        if (QCar2_autonomous_driving_exam_B.minsat < 0) {
          minimum = 0;
        } else if (QCar2_autonomous_driving_exam_B.minsat > 255U) {
          minimum = 255U;
        } else {
          minimum = (t_uint8) QCar2_autonomous_driving_exam_B.minsat;
        }

        if (QCar2_autonomous_driving_exam_B.maxsat < 0) {
          maximum = 0;
        } else if (QCar2_autonomous_driving_exam_B.maxsat > 255U) {
          maximum = 255U;
        } else {
          maximum = (t_uint8) QCar2_autonomous_driving_exam_B.maxsat;
        }
      } else {
        minimum = (t_uint8) (QCar2_autonomous_driving_exam_B.minsat - 256U *
                             floor(QCar2_autonomous_driving_exam_B.minsat / 256U));
        maximum = (t_uint8) (QCar2_autonomous_driving_exam_B.maxsat - 256U *
                             floor(QCar2_autonomous_driving_exam_B.maxsat / 256U));
      }
      ...
      if ((comparison2 & COMPARE_WRAP) == 0) {
        if (QCar2_autonomous_driving_exam_B.minval < 0) {
          minimum = 0;
        } else if (QCar2_autonomous_driving_exam_B.minval > 255U) {
          minimum = 255U;
        } else {
          minimum = (t_uint8) QCar2_autonomous_driving_exam_B.minval;
        }

        if (QCar2_autonomous_driving_exam_B.maxval < 0) {
          maximum = 0;
        } else if (QCar2_autonomous_driving_exam_B.maxval > 255U) {
          maximum = 255U;
        } else {
          maximum = (t_uint8) QCar2_autonomous_driving_exam_B.maxval;
        }
      } else {
        minimum = (t_uint8) (QCar2_autonomous_driving_exam_B.minval - 256U *
                             floor(QCar2_autonomous_driving_exam_B.minval / 256U));
        maximum = (t_uint8) (QCar2_autonomous_driving_exam_B.maxval - 256U *
                             floor(QCar2_autonomous_driving_exam_B.maxval / 256U));
      }
   ...
   */
  QCar2_autonomous_driving_exa_DW.sfEvent_c = QCar2_autonomous_dri_CALL_EVENT;
  ...
  for (i = 0; i < d; i++) {
    if (dimIdx_idx_0 - 1 >= 0) {
      memset(&QCar2_autonomous_driving_exam_B.y_j[i * 200 + (portWid + y_f_tmp *
              200)], 255, (uint32_T)((((dimIdx_idx_0 + portWid) + y_f_tmp * 200)
               - portWid) - y_f_tmp * 200) * sizeof(uint8_T));
    }
  }
   ...
   *  Sum: '<S7>/Sum'
   */
  u0 = (QCar2_autonomous_driving_exam_P.NomimalLanePositionPixelColumn_ -
  ...
  if (u0 > QCar2_autonomous_driving_exam_P.SteeringSaturation1_UpperSat) {
    /* Saturate: '<Root>/Steering Saturation1' */
    QCar2_autonomous_driving_exam_B.SteeringSaturation1 =
      QCar2_autonomous_driving_exam_P.SteeringSaturation1_UpperSat;
  } else if (u0 < QCar2_autonomous_driving_exam_P.SteeringSaturation1_LowerSat)
  {
    /* Saturate: '<Root>/Steering Saturation1' */
    QCar2_autonomous_driving_exam_B.SteeringSaturation1 =
    ...
    /* Saturate: '<Root>/Steering Saturation1' */
    QCar2_autonomous_driving_exam_B.SteeringSaturation1 = u0;
  }
  ...
  /* S-Function Block: QCar2_autonomous_driving_example1/colorThresholdingHSV/Combined  Displays/Channel (channel_block) */
  {
    if (rtExtModeQuarcIsConnected()) {
      ...
      size_t width = 1;
      QCar2_autonomous_driving_exam_B.Channel_f = CHANNEL_3;
      info.header.data_type_id = 3;
      info.header.channel = 3;
      info.header.flags = CHANNEL_FLAG_VARIABLE_SIZE;
      info.header.num_dimensions = 1;
      width *= QCar2_autonomous_driving_exa_DW.ImageCompress_DIMS1_f;
      info.header.dimension[0] =
        QCar2_autonomous_driving_exa_DW.ImageCompress_DIMS1_f;
      channel_fifo_add((t_channel_fifo)
                       QCar2_autonomous_driving_exa_DW.Channel_PWORK_a.Fifo,
                       &info.header,
                       &QCar2_autonomous_driving_exam_B.ImageCompress_m[0],
  ...
  /* S-Function Block: QCar2_autonomous_driving_example1/colorThresholdingHSV/Filtered Image/Channel (channel_block) */
  {
    if (rtExtModeQuarcIsConnected()) {
      ...
      size_t width = 1;
      QCar2_autonomous_driving_exam_B.Channel_m = CHANNEL_4;
      info.header.data_type_id = 3;
      info.header.channel = 4;
      info.header.flags = CHANNEL_FLAG_VARIABLE_SIZE;
      info.header.num_dimensions = 1;
      width *= QCar2_autonomous_driving_exa_DW.ImageCompress_DIMS1_b;
      info.header.dimension[0] =
        QCar2_autonomous_driving_exa_DW.ImageCompress_DIMS1_b;
      channel_fifo_add((t_channel_fifo)
                       QCar2_autonomous_driving_exa_DW.Channel_PWORK_f.Fifo,
                       &info.header,
                       &QCar2_autonomous_driving_exam_B.ImageCompress_a[0],
                       width * sizeof(uint8_T));
    }
  }
  ...
  for (i = 0; i < 164000; i++) {
     ...
     *  S-Function (image_compare_block): '<S17>/HSV Color Thresholding1'
     */
    QCar2_autonomous_driving_exam_B.MatrixConcatenate[i] =
      QCar2_autonomous_driving_exam_B.HSVColorThresholding1_o1[i];

    /* SignalConversion generated from: '<S17>/Matrix Concatenate' incorporates:
     *  S-Function (image_compare_block): '<S17>/HSV Color Thresholding1'
     */
    QCar2_autonomous_driving_exam_B.MatrixConcatenate[i + 164000] =
      QCar2_autonomous_driving_exam_B.HSVColorThresholding1_o2[i];

    /* SignalConversion generated from: '<S17>/Matrix Concatenate' incorporates:
     *  S-Function (image_compare_block): '<S17>/HSV Color Thresholding1'
     */
    QCar2_autonomous_driving_exam_B.MatrixConcatenate[i + 328000] =
  ...
  /* S-Function Block: QCar2_autonomous_driving_example1/colorThresholdingHSV/Channel (channel_block) */
  {
    if (rtExtModeQuarcIsConnected()) {
      ...
      QCar2_autonomous_driving_exam_B.Channel_i = CHANNEL_2;
      info.header.data_type_id = 3;
      info.header.channel = 2;
      info.header.flags = 0;
      info.header.num_dimensions = 2;
      info.header.dimension[0] = 200;
      info.header.dimension[1] = 2460;
      channel_fifo_add((t_channel_fifo)
                       QCar2_autonomous_driving_exa_DW.Channel_PWORK_m.Fifo,
                       &info.header,
                       &QCar2_autonomous_driving_exam_B.MatrixConcatenate[0],
                       492000 * sizeof(uint8_T));
    }
  }
}
...
void QCar2_autonomous_driving_example1_output4(void) /* Sample time: [0.1s, 0.0s] */
{
   ...
   */
  QCar2_autonomous_driving_exa_DW.sfEvent_fz = QCar2_autonomous_dri_CALL_EVENT;
   ...
   */
  QCar2_autonomous_driving_exa_DW.sfEvent_f = QCar2_autonomous_dri_CALL_EVENT;
  y_n[0] = QCar2_autonomous_driving_exa_DW.RateTransition7_Buffer[2];
  y_n[5] = QCar2_autonomous_driving_exa_DW.RateTransition7_Buffer[0];
  y_n[1] = QCar2_autonomous_driving_exa_DW.RateTransition7_Buffer[2];
  y_n[6] = QCar2_autonomous_driving_exa_DW.RateTransition7_Buffer[1];
  y_n[2] = QCar2_autonomous_driving_exa_DW.RateTransition7_Buffer[3];
  y_n[7] = QCar2_autonomous_driving_exa_DW.RateTransition7_Buffer[1];
  y_n[3] = QCar2_autonomous_driving_exa_DW.RateTransition7_Buffer[3];
  y_n[8] = QCar2_autonomous_driving_exa_DW.RateTransition7_Buffer[0];
  y_n[4] = QCar2_autonomous_driving_exa_DW.RateTransition7_Buffer[2];
  y_n[9] = QCar2_autonomous_driving_exa_DW.RateTransition7_Buffer[0];

  /* MATLAB Function: '<S4>/Draw Lines Module1' */
  QCar2_autonomous_driving_exa_DW.sfEvent_l = QCar2_autonomous_dri_CALL_EVENT;
  QCar2_autonomous_emxInit_real_T(&row_vec, 2);
  QCar2_autonomous_emxInit_real_T(&col_vec, 2);
  ...
  for (c_k = 0; c_k < 4; c_k++) {
    ...
    itr_tmp = y_n[c_k + 5];
    itr_tmp_0 = y_n[c_k + 6];
    itr = fmax(fabs(y_n_0 - y_n_1), fabs(itr_tmp - itr_tmp_0));
    QCar2_autonomous_drivi_linspace(y_n_0, y_n_1, itr, row_vec);
    nx = row_vec->size[1];
    for (i = 0; i < nx; i++) {
    ...
    nx = (int32_T)itr;
    for (i = 0; i < nx; i++) {
      y_n_0 = col_vec->data[i];
      y_n_1 = row_vec->data[i];
      itr_tmp = rt_roundd_snf(QCar2_autonomous_driving_exam_P.Constant2_Value_k
        [0]);
      if (itr_tmp < 256.0) {
        if (itr_tmp >= 0.0) {
          QCar2_autonomous_driving_exam_B.img_out_e[((int32_T)y_n_1 + 200 *
            ((int32_T)y_n_0 - 1)) - 1] = (uint8_T)itr_tmp;
        } else {
          QCar2_autonomous_driving_exam_B.img_out_e[((int32_T)y_n_1 + 200 *
            ((int32_T)y_n_0 - 1)) - 1] = 0U;
        }
      } else {
        QCar2_autonomous_driving_exam_B.img_out_e[((int32_T)y_n_1 + 200 *
          ((int32_T)y_n_0 - 1)) - 1] = MAX_uint8_T;
      }
      ...
      if (itr_tmp < 256.0) {
        if (itr_tmp >= 0.0) {
          QCar2_autonomous_driving_exam_B.img_out_e[((int32_T)y_n_1 + 200 *
            ((int32_T)y_n_0 - 1)) + 163999] = (uint8_T)itr_tmp;
        } else {
          QCar2_autonomous_driving_exam_B.img_out_e[((int32_T)y_n_1 + 200 *
            ((int32_T)y_n_0 - 1)) + 163999] = 0U;
        }
      } else {
        QCar2_autonomous_driving_exam_B.img_out_e[((int32_T)y_n_1 + 200 *
          ((int32_T)y_n_0 - 1)) + 163999] = MAX_uint8_T;
      }
      ...
      if (itr_tmp < 256.0) {
        if (itr_tmp >= 0.0) {
          QCar2_autonomous_driving_exam_B.img_out_e[((int32_T)y_n_1 + 200 *
            ((int32_T)y_n_0 - 1)) + 327999] = (uint8_T)itr_tmp;
        } else {
          QCar2_autonomous_driving_exam_B.img_out_e[((int32_T)y_n_1 + 200 *
            ((int32_T)y_n_0 - 1)) + 327999] = 0U;
        }
      } else {
        QCar2_autonomous_driving_exam_B.img_out_e[((int32_T)y_n_1 + 200 *
          ((int32_T)y_n_0 - 1)) + 327999] = MAX_uint8_T;
      }
    }
  }
   ...
   */
  QCar2_autonomous_driving_exa_DW.sfEvent_g0 = QCar2_autonomous_dri_CALL_EVENT;
  ...
  QCar2_autonomous_driving_exa_DW.sfEvent_i = QCar2_autonomous_dri_CALL_EVENT;

  /* MATLAB Function: '<S4>/Draw Lines Module2' incorporates:
   *  MATLAB Function: '<S4>/MATLAB Function3'
   *  RateTransition: '<Root>/Rate Transition10'
   */
  QCar2_autonomous_driving_exa_DW.sfEvent_e = QCar2_autonomous_dri_CALL_EVENT;
  ...
  /* S-Function Block: QCar2_autonomous_driving_example1/Display Tracking Diagnostics/Channel (channel_block) */
  {
    if (rtExtModeQuarcIsConnected()) {
      ...
      size_t width = 1;
      QCar2_autonomous_driving_exam_B.Channel_a = CHANNEL_1;
      info.header.data_type_id = 3;
      info.header.channel = 1;
      info.header.flags = CHANNEL_FLAG_VARIABLE_SIZE;
      info.header.num_dimensions = 1;
      width *= QCar2_autonomous_driving_exa_DW.ImageCompress_DIMS1_e;
      info.header.dimension[0] =
        QCar2_autonomous_driving_exa_DW.ImageCompress_DIMS1_e;
      channel_fifo_add((t_channel_fifo)
                       QCar2_autonomous_driving_exa_DW.Channel_PWORK_o.Fifo,
                       &info.header,
                       &QCar2_autonomous_driving_exam_B.ImageCompress_l[0],
                       width * sizeof(uint8_T));
    }
  }
}
...
void QCar2_autonomous_driving_example1_initialize(void)
{
  ...
  /* Start for Constant: '<S17>/min hue' */
  QCar2_autonomous_driving_exam_B.minhue =
    QCar2_autonomous_driving_exam_P.minhue_Value;

  /* Start for Constant: '<S17>/min sat' */
  QCar2_autonomous_driving_exam_B.minsat =
    QCar2_autonomous_driving_exam_P.minsat_Value;

  /* Start for Constant: '<S17>/min val' */
  QCar2_autonomous_driving_exam_B.minval =
    QCar2_autonomous_driving_exam_P.minval_Value;

  /* Start for Constant: '<S17>/max hue' */
  QCar2_autonomous_driving_exam_B.maxhue =
    QCar2_autonomous_driving_exam_P.maxhue_Value;

  /* Start for Constant: '<S17>/max sat' */
  QCar2_autonomous_driving_exam_B.maxsat =
    QCar2_autonomous_driving_exam_P.maxsat_Value;

  /* Start for Constant: '<S17>/max val' */
  QCar2_autonomous_driving_exam_B.maxval =
    QCar2_autonomous_driving_exam_P.maxval_Value;
  ...
  {
    t_error result;
    result = channel_fifo_create(3, sizeof(uint8_T), 1, 164000, 1,
      (t_channel_fifo *) &QCar2_autonomous_driving_exa_DW.Channel_PWORK_a.Fifo);
    if (result < 0) {
      msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
        (_rt_error_message));
      rtmSetErrorStatus(QCar2_autonomous_driving_exa_M, _rt_error_message);
  ...
  {
    t_error result;
    result = channel_fifo_create(4, sizeof(uint8_T), 1, 164000, 1,
      (t_channel_fifo *) &QCar2_autonomous_driving_exa_DW.Channel_PWORK_f.Fifo);
    if (result < 0) {
      msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
        (_rt_error_message));
      rtmSetErrorStatus(QCar2_autonomous_driving_exa_M, _rt_error_message);
  ...
  {
    t_error result;
    result = channel_fifo_create(2, sizeof(uint8_T), 2, 492000, 1,
  ...
  {
    t_error result;
    result = channel_fifo_create(1, sizeof(uint8_T), 1, 492000, 1,
      (t_channel_fifo *) &QCar2_autonomous_driving_exa_DW.Channel_PWORK_o.Fifo);
    if (result < 0) {
      msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
        (_rt_error_message));
      rtmSetErrorStatus(QCar2_autonomous_driving_exa_M, _rt_error_message);
...

  {
    ...
    /* SystemInitialize for MATLAB Function: '<S4>/Draw Lines Module1' */
    QCar2_autonomous_driving_exa_DW.doneDoubleBufferReInit_b = false;
    QCar2_autonomous_driving_exa_DW.sfEvent_l = QCar2_autonomous_dri_CALL_EVENT;

    /* SystemInitialize for MATLAB Function: '<S4>/Draw Lines Module2' */
    QCar2_autonomous_driving_exa_DW.doneDoubleBufferReInit_mb = false;
    QCar2_autonomous_driving_exa_DW.sfEvent_e = QCar2_autonomous_dri_CALL_EVENT;

    /* SystemInitialize for MATLAB Function: '<S4>/Draw Lines Module3' */
    ...
    QCar2_autonomous_driving_exa_DW.doneDoubleBufferReInit_dg = false;
    QCar2_autonomous_driving_exa_DW.sfEvent_f = QCar2_autonomous_dri_CALL_EVENT;

    /* SystemInitialize for MATLAB Function: '<S4>/MATLAB Function2' */
    QCar2_autonomous_driving_exa_DW.doneDoubleBufferReInit_m = false;
    QCar2_autonomous_driving_exa_DW.sfEvent_o = QCar2_autonomous_dri_CALL_EVENT;

    /* SystemInitialize for MATLAB Function: '<S4>/MATLAB Function3' */
    ...
    QCar2_autonomous_driving_exa_DW.doneDoubleBufferReInit_n = false;
    QCar2_autonomous_driving_exa_DW.sfEvent_j = QCar2_autonomous_dri_CALL_EVENT;

    /* SystemInitialize for MATLAB Function: '<Root>/MATLAB Function' */
    QCar2_autonomous_driving_exa_DW.doneDoubleBufferReInit_at = false;
    QCar2_autonomous_driving_exa_DW.sfEvent_a = QCar2_autonomous_dri_CALL_EVENT;

    /* SystemInitialize for MATLAB Function: '<S11>/Mask' */
    QCar2_autonomous_driving_exa_DW.doneDoubleBufferReInit_a = false;
    QCar2_autonomous_driving_exa_DW.sfEvent_c = QCar2_autonomous_dri_CALL_EVENT;
    ...
    /* SystemInitialize for MATLAB Function: '<S19>/Draw Lines Module' */
    ...
    /* SystemInitialize for MATLAB Function: '<S19>/Steering based  image subselector' */
...
void QCar2_autonomous_driving_example1_terminate(void)
{
  ...
  /* S-Function Block: QCar2_autonomous_driving_example1/colorThresholdingHSV/Combined  Displays/Channel (channel_block) */
  {
    channel_fifo_destroy((t_channel_fifo)
                         QCar2_autonomous_driving_exa_DW.Channel_PWORK_a.Fifo);
    QCar2_autonomous_driving_exa_DW.Channel_PWORK_a.Fifo = NULL;
  }
  ...
  /* S-Function Block: QCar2_autonomous_driving_example1/colorThresholdingHSV/Filtered Image/Channel (channel_block) */
  {
    channel_fifo_destroy((t_channel_fifo)
                         QCar2_autonomous_driving_exa_DW.Channel_PWORK_f.Fifo);
    QCar2_autonomous_driving_exa_DW.Channel_PWORK_f.Fifo = NULL;
  }
  ...
  /* S-Function Block: QCar2_autonomous_driving_example1/Display Tracking Diagnostics/Channel (channel_block) */
  {
    channel_fifo_destroy((t_channel_fifo)
                         QCar2_autonomous_driving_exa_DW.Channel_PWORK_o.Fifo);
    QCar2_autonomous_driving_exa_DW.Channel_PWORK_o.Fifo = NULL;
  }
}
...
RT_MODEL_QCar2_autonomous_dri_T *QCar2_autonomous_driving_example1(void)
{
  ...
  /* External mode info */
  QCar2_autonomous_driving_exa_M->Sizes.checksums[0] = (205858571U);
  QCar2_autonomous_driving_exa_M->Sizes.checksums[1] = (2076415648U);
  QCar2_autonomous_driving_exa_M->Sizes.checksums[2] = (3348101739U);
  QCar2_autonomous_driving_exa_M->Sizes.checksums[3] = (888618615U);
  ...
  QCar2_autonomous_driving_exa_M->Sizes.numBlocks = (230);/* Number of blocks */
  QCar2_autonomous_driving_exa_M->Sizes.numBlockIO = (77);/* Number of block outputs */
  QCar2_autonomous_driving_exa_M->Sizes.numBlockPrms = (375);/* Sum of parameter "widths" */
