...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&QCar2_hardware_test_intel_rea_B.Depth_o2), 20, 0, 2 },

  { (char_T *)(&QCar2_hardware_test_intel_rea_B.Depth_o3), 0, 0, 2 },

  { (char_T *)(&QCar2_hardware_test_intel_rea_B.Channel), 15, 0, 2 },
  ...
  { (char_T *)(&QCar2_hardware_test_intel_re_DW.ImageCompress_Compress), 16, 0,
    2 },

  { (char_T *)(&QCar2_hardware_test_intel_re_DW.Video3DInitialize_Video3D), 17,
    0, 3 },

  { (char_T *)(&QCar2_hardware_test_intel_re_DW.Depth_Stream), 18, 0, 2 },

  { (char_T *)(&QCar2_hardware_test_intel_re_DW.ImageTransform_AlgHandle), 21, 0,
    1 },
