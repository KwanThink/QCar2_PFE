/*
 * QCar2_hardware_test_intel_realsense.h
 *
...
#ifndef QCar2_hardware_test_intel_realsense_h_
#define QCar2_hardware_test_intel_realsense_h_
#ifndef QCar2_hardware_test_intel_realsense_COMMON_INCLUDES_
#define QCar2_hardware_test_intel_realsense_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                /* QCar2_hardware_test_intel_realsense_COMMON_INCLUDES_ */

#include "QCar2_hardware_test_intel_realsense_types.h"
...
#define QCar2_hardware_test_intel_realsense_rtModel RT_MODEL_QCar2_hardware_test__T

/* Block signals (default storage) */
typedef struct {
  t_uint64 Depth_o2;                   /* '<Root>/Depth' */
  t_uint64 RGB_o2;                     /* '<Root>/RGB' */
  real_T Depth_o3;                     /* '<Root>/Depth' */
  real_T RGB_o3;                       /* '<Root>/RGB' */
  t_channel Channel;                   /* '<S1>/Channel' */
  t_channel Channel_a;                 /* '<S4>/Channel' */
  real32_T Depth_o1[921600];           /* '<Root>/Depth' */
  uint8_T RGB_o1[2764800];             /* '<Root>/RGB' */
  uint8_T ImageCompress[2764800];      /* '<S1>/Image Compress' */
  uint8_T ImageCompress_l[2764800];    /* '<S4>/Image Compress' */
  uint8_T ImageTransform[2764800];     /* '<Root>/Image Transform' */
} B_QCar2_hardware_test_intel_r_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  t_jpeg_compress ImageCompress_Compress;/* '<S1>/Image Compress' */
  t_jpeg_compress ImageCompress_Compress_g;/* '<S4>/Image Compress' */
  t_video3d Video3DInitialize_Video3D; /* '<Root>/Video3D Initialize' */
  t_video3d Depth_Video3D;             /* '<Root>/Depth' */
  t_video3d RGB_Video3D;               /* '<Root>/RGB' */
  t_video3d_stream Depth_Stream;       /* '<Root>/Depth' */
  t_video3d_stream RGB_Stream;         /* '<Root>/RGB' */
  t_colorization ImageTransform_AlgHandle;/* '<Root>/Image Transform' */
  struct {
    void *Fifo;
  } Channel_PWORK;                     /* '<S1>/Channel' */

  struct {
    void *Fifo;
  } Channel_PWORK_i;                   /* '<S4>/Channel' */

  int32_T ImageCompress_DIMS1;         /* '<S1>/Image Compress' */
  int32_T ImageCompress_DIMS1_h;       /* '<S4>/Image Compress' */
  uint8_T ImageCompress_ScanLine[30720];/* '<S1>/Image Compress' */
  uint8_T ImageCompress_ScanLine_g[30720];/* '<S4>/Image Compress' */
} DW_QCar2_hardware_test_intel__T;

/* Backward compatible GRT Identifiers */
#define rtB                            QCar2_hardware_test_intel_rea_B
#define BlockIO                        B_QCar2_hardware_test_intel_r_T
#define rtP                            QCar2_hardware_test_intel_rea_P
#define Parameters                     P_QCar2_hardware_test_intel_r_T
#define rtDWork                        QCar2_hardware_test_intel_re_DW
#define D_Work                         DW_QCar2_hardware_test_intel__T

/* Parameters (default storage) */
struct P_QCar2_hardware_test_intel_r_T_ {
...
struct tag_RTM_QCar2_hardware_test_i_T {
  const char_T *path;
...
extern P_QCar2_hardware_test_intel_r_T QCar2_hardware_test_intel_rea_P;

/* Block signals (default storage) */
extern B_QCar2_hardware_test_intel_r_T QCar2_hardware_test_intel_rea_B;

/* Block states (default storage) */
extern DW_QCar2_hardware_test_intel__T QCar2_hardware_test_intel_re_DW;

/* Model entry point functions */
extern void QCar2_hardware_test_intel_realsense_initialize(void);
extern void QCar2_hardware_test_intel_realsense_output(void);
extern void QCar2_hardware_test_intel_realsense_update(void);
extern void QCar2_hardware_test_intel_realsense_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern QCar2_hardware_test_intel_realsense_rtModel
  *QCar2_hardware_test_intel_realsense(void);
...
extern RT_MODEL_QCar2_hardware_test__T *const QCar2_hardware_test_intel_re_M;
 ...
 *
 * '<Root>' : 'QCar2_hardware_test_intel_realsense'
 * '<S1>'   : 'QCar2_hardware_test_intel_realsense/Colorized Depth Image'
 * '<S2>'   : 'QCar2_hardware_test_intel_realsense/Powered by QUARC'
 * '<S3>'   : 'QCar2_hardware_test_intel_realsense/Quanser'
 * '<S4>'   : 'QCar2_hardware_test_intel_realsense/RGB Image'
 */
#endif                              /* QCar2_hardware_test_intel_realsense_h_ */
