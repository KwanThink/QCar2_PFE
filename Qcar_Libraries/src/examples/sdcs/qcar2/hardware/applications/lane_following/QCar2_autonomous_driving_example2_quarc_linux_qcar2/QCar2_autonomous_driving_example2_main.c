 ...
 * External functions *
 *====================*/
EXTERN RT_MODEL * QCar2_autonomous_driving_example2(void);
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: QCar2_autonomous_driving_example2 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  S = QCar2_autonomous_driving_example2();
  if (rtmGetErrorStatus(S) != NULL) {
