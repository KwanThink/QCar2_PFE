...
typedef struct {
  ...
  real_T HILRead_o4;                   /* '<S13>/HIL Read' */
  real_T HILRead_o5;                   /* '<S13>/HIL Read' */
  real_T HILRead_o6;                   /* '<S13>/HIL Read' */
  real_T HILRead_o7;                   /* '<S13>/HIL Read' */
  real_T HILRead_o8;                   /* '<S13>/HIL Read' */
  real_T HILRead_o9;                   /* '<S13>/HIL Read' */
  ...
  real_T DesiredSpeedms;               /* '<S21>/Switch' */
  real_T desired;                      /* '<S20>/Multiply1' */
  real_T Kffms;                        /* '<S20>/Kff  (% // m//s)' */
  real_T measured;                     /* '<S20>/Multiply' */
  ...
  real_T ComputationTime;              /* '<S3>/Computation Time' */
  real_T RateTransition4[3];           /* '<Root>/Rate Transition4' */
  real_T RateTransition3[3];           /* '<Root>/Rate Transition3' */
  real_T Kim;                          /* '<S20>/Ki (% // m)  ' */
  real_T Depth_o3;                     /* '<S16>/Depth' */
  real_T minhue;                       /* '<S17>/min hue' */
  real_T minsat;                       /* '<S17>/min sat' */
  real_T minval;                       /* '<S17>/min val' */
  real_T maxhue;                       /* '<S17>/max hue' */
  real_T maxsat;                       /* '<S17>/max sat' */
  real_T maxval;                       /* '<S17>/max val' */
  real_T Width;                        /* '<S7>/Width' */
  real_T SteeringSaturation1;          /* '<Root>/Steering Saturation1' */
  real_T Multiply;                     /* '<S19>/Multiply' */
  real_T y;                            /* '<S19>/MATLAB Function' */
  real_T speed_cmd;                    /* '<S12>/MATLAB Function' */
  ...
  uint8_T MatrixConcatenate[492000];   /* '<S17>/Matrix Concatenate' */
  ...
  boolean_T VideoCapture_o2;           /* '<S15>/Video Capture' */
...
typedef struct {
  ...
  struct {
    void *LoggedData[2];
  } Scope_PWORK_d;                     /* '<S20>/Scope' */

  struct {
    void *LoggedData[2];
  } Scope_PWORK_a;                     /* '<S21>/Scope' */
  ...
  struct {
    void *LoggedData;
  } SteeringCommand_PWORK;             /* '<Root>/Steering Command' */

  struct {
    void *LoggedData;
  } Scope_PWORK_b;                     /* '<S15>/Scope' */
  ...
  int32_T sfEvent;               /* '<S19>/Steering based  image subselector' */
  int32_T sfEvent_g;                   /* '<S19>/MATLAB Function' */
  int32_T sfEvent_gp;                  /* '<S19>/Draw Lines Module' */
  int32_T sfEvent_n;                   /* '<S12>/MATLAB Function' */
  int32_T sfEvent_c;                   /* '<S11>/Mask' */
  int32_T sfEvent_a;                   /* '<Root>/MATLAB Function' */
  int32_T sfEvent_j;                   /* '<S7>/MATLAB Function' */
  int32_T sfEvent_i;                   /* '<S4>/MATLAB Function3' */
  int32_T sfEvent_o;                   /* '<S4>/MATLAB Function2' */
  int32_T sfEvent_f;                   /* '<S4>/MATLAB Function1' */
  int32_T sfEvent_fz;                  /* '<S4>/MATLAB Function' */
  int32_T sfEvent_g0;                  /* '<S4>/Draw Lines Module3' */
  int32_T sfEvent_e;                   /* '<S4>/Draw Lines Module2' */
  int32_T sfEvent_l;                   /* '<S4>/Draw Lines Module1' */
  ...
  boolean_T doneDoubleBufferReInit;
                                 /* '<S19>/Steering based  image subselector' */
  boolean_T doneDoubleBufferReInit_e;  /* '<S19>/MATLAB Function' */
  boolean_T doneDoubleBufferReInit_eh; /* '<S19>/Draw Lines Module' */
  boolean_T doneDoubleBufferReInit_o;  /* '<S12>/MATLAB Function' */
  boolean_T doneDoubleBufferReInit_a;  /* '<S11>/Mask' */
  boolean_T doneDoubleBufferReInit_at; /* '<Root>/MATLAB Function' */
  boolean_T doneDoubleBufferReInit_n;  /* '<S7>/MATLAB Function' */
  boolean_T last_location_not_empty;   /* '<S7>/MATLAB Function' */
  boolean_T doneDoubleBufferReInit_d;  /* '<S4>/MATLAB Function3' */
  boolean_T doneDoubleBufferReInit_m;  /* '<S4>/MATLAB Function2' */
  boolean_T doneDoubleBufferReInit_dg; /* '<S4>/MATLAB Function1' */
  boolean_T doneDoubleBufferReInit_i;  /* '<S4>/MATLAB Function' */
  boolean_T doneDoubleBufferReInit_g;  /* '<S4>/Draw Lines Module3' */
  boolean_T doneDoubleBufferReInit_mb; /* '<S4>/Draw Lines Module2' */
  boolean_T doneDoubleBufferReInit_b;  /* '<S4>/Draw Lines Module1' */
