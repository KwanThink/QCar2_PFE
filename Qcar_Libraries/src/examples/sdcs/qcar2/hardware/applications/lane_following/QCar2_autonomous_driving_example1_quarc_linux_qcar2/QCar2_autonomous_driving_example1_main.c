...
typedef RT_MODEL_QCar2_autonomous_dri_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * QCar2_autonomous_driving_example1(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(QCar2_autonomous_driving_exa_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: QCar2_autonomous_driving_example1 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  S = QCar2_autonomous_driving_example1();
  if (rtmGetErrorStatus(S) != NULL) {
                ...
                while (result == 0) {
...

                  {
                    ...
                    if (local_result < 0) {
                      ...
                      rtmSetErrorStatus(QCar2_autonomous_driving_exa_M,
                                        _rt_error_message);
                    }
                  }
